...
def conectar_db():
    ...
    try:
        ...
        # print(Fore.GREEN + f"✅ Conexión a la base de datos '{ARCHIVO_DB}' establecida." + Style.RESET_ALL)
        return conn
...
def crear_tablas():
    """
    Crea las tablas 'usuarios' y 'productos' si no existen.
    ...
    if conn:
        try:
            ...
            conn.close()
            # print(Fore.CYAN + "⚙️ Conexión a DB cerrada después de crear tablas." + Style.RESET_ALL)
    else:
...
def obtener_usuario(nombre_usuario, contrasena):
    """
...
# Bloque de prueba para el módulo database.py
