...
def alta_usuario():
    ...
    try:
        ...
        while True:
            ...
            if not contrasena:# Verifica si la contraseña está vacía
    ...
    except EOFError:# Captura si se termina la entrada de forma inesperada
        print(Fore.RED + "❌ Entrada terminada inesperadamente. No se pudo leer el usuario o la contraseña." + Style.RESET_ALL)
    except KeyboardInterrupt:# Captura si el usuario interrumpe la entrada con Ctrl+C
...
def main():
    ...
    # Es crucial que esta llamada se haga antes de cualquier operación de DB. #ya que si no existe la tabla de usuarios, no se podrá hacer el alta ni el login.
