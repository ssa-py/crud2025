...
def mostrar_ayuda_general():
    ...
    print("\n")
    print(Style.BRIGHT + "1.  Inicio de Sesión:" + Style.RESET_ALL)
    ...
    print("\n")
    print(Style.BRIGHT + "2.  Menú Principal (Gestión de Productos):" + Style.RESET_ALL)
    ...
    print("\n")
    print(Style.BRIGHT + "3.  Registro de Actividad (log.txt):" + Style.RESET_ALL)
    ...
    print("\n")
    print(Style.BRIGHT + "4.  Base de Datos (inventario.db):" + Style.RESET_ALL)
    ...
    print(Fore.GREEN + "\n¡Esperamos que esta guía te sea de gran utilidad para gestionar tu inventario eficientemente!" + Style.RESET_ALL)
...
def menu_ayuda():
    ...
    while True:
        ...
        if opcion == 1:
            ...
            mostrar_docstring(main)
        elif opcion == 3:
            mostrar_docstring(login)
        elif opcion == 4:
            mostrar_docstring(productos)
        elif opcion == 5:
            mostrar_docstring(database)
        elif opcion == 6: # MODIFICADO: Lógica para la selección interactiva de funciones
            while True:
